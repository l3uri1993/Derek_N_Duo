/**
 * @file motor_driver.h
 * @brief Motor device driver definition for the Derek robot.
 */

#ifndef _MOTOR_DRIVER_DEF
#define _MOTOR_DRIVER_DEF
...
namespace Derek
{
    ...
    public:
         ...
         */
		virtual void setMotor(int speed) = 0;						//interface, implemented in the subclass

        /**
         * @brief Return the current speed of the motor.
         * @return The current speed of the motor with range -255 to 255.
         */
		virtual int getSpeed() const = 0;							//interface, implemented in the subclass
    };
};
